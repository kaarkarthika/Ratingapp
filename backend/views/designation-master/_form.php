...
<div class="row">
    ...
    <?= $form->field($model, 'DesignationName')->textInput(['maxlength' => true]) ?>
</div>
<div class='col-sm-6 form-group' >
 ...
 <div class="row">
    ...
    <div class="form-group pull-right">
        <?php echo Html::a('<span class="fa fa-remove"></span> Cancel', '?r=floor-master/index', ['class'=> "btn btn-sm btn-danger"]); ?>
