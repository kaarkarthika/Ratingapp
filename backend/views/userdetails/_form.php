    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                     <h3 class="box-title"><?= $model->isNewRecord ? '<i class="fa fa-fw fa-user-plus"></i>' : '<i class="fa fa-fw fa-user"></i>' ?>  User Details</h3>
              </div><!-- /.box-header -->
...
<div class="box-body">
	...
	<div class="form-group col-md-6">
	<?= $form->field($model, 'mobile_number')->textInput(['maxlength' => true, 'placeholder' => 'Mobile Number','maxlength' => 10,'onkeypress'=>'return isNumberKey(event)']) ?>
	</div>
	...
	<div class="col-md-12">
	<div class="form-group col-md-6">
  <?= $form->field($model, 'support_number')->textInput(['maxlength' => true, 'placeholder' => 'Support Number','maxlength' => 10,'onkeypress'=>'return isNumberKey(event)'])->label('Support Number') ?>
  </div>
	 <div class="form-group col-md-6">
    ...
    <?= $form->field($model, 'username')->textInput(['maxlength' => true, 'placeholder' => 'Login Username','readonly'=>'true']) ?>
    </div>
