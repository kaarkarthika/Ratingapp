...
<div class="row">
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'moduleCode2')->textInput(['maxlength' => true]) ?>
</div>
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'moduleCode3')->textInput(['maxlength' => true]) ?>
</div>
</div>
<div class="row">
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'moduleMultiple')->dropDownList([ 'one' => 'One', 'more' => 'More', 'sub' => 'Sub', 'identify' => 'Identify', ], ['prompt' => '']) ?>
</div>
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'moduelRoot')->textInput(['maxlength' => true]) ?>
</div>
</div>
<div class="row">
<div class='col-sm-6 form-group' >
...
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'userAction')->textInput(['maxlength' => true]) ?>
</div>
</div>
<div class="row">
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'FAIcon')->textInput(['maxlength' => true]) ?>
</div>
<div class='col-sm-6 form-group' >
...
<div class="row">
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'user_rights')->textarea(['rows' => 6]) ?>
</div>
<div class='col-sm-6 form-group' >
...
<div class="row">
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'module_show_status')->textarea(['rows' => 6]) ?>
</div>
<div class='col-sm-6 form-group' >
    <?= $form->field($model, 'admin_lead_opn')->textInput() ?>
</div>
</div>
     <br>
            <br>
