...
<div class="auth-project-module-index">
   ...
   <?= Html::a('Add Auth Project Module', ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </div>
    </div>
...
<script type="text/javascript">
     $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>Auth Project Module</span>');
