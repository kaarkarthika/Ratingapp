 ...
 */
class TechnicianMaster extends \yii\db\ActiveRecord implements IdentityInterface
{
    /**
     * @inheritdoc
     */
...
public function login()
    {
        ...
        if ($username!='' && $password!='') {
            $user_data = TechnicianMaster::find()->where(['user_name' => $username])->one();
           // echo "<pre>"; print_r($user_data); die;
			...
			if(Yii::$app->security->validatePassword($password,$haspassword)){
                ...
                $session['technician_id']  = $user_data->auto_id;
